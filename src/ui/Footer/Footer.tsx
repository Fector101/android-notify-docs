    ...
    return (
        <footer className='flex justify-content-cen text-align-center align-items-cen'>
            ...
            <div className="flex fd-column gap-10">
                <p>Thoroughly Tested and supported by <br/><Link href='https://github.com/Fector101/laner'>Laner</Link> & <Link href='https://github.com/Fector101/wallpaper-carousel'>The Carousel</Link> </p>
